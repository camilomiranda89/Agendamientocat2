              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Bienvenido a Sistema de Agendamiento de CAT2</h1>
                  </div>
                  <form class="user">
                  ...
                  <hr>
                  <div class="text-center">
                    <a class="small" href="#">Olvidastes tu contraseña?</a>
                  </div>
                  <div class="text-center">
